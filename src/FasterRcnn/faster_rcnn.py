...
from src.FasterRcnn.hrnetv2 import get_initialize_model
from src.model_utils.config import config as default_cfg
from src.FasterRcnn.bbox_assign_sample_stage2 import BboxAssignSampleForRcnn
from src.FasterRcnn.hrfpn import HrnetFpn
from src.FasterRcnn.proposal_generator import Proposal
from src.FasterRcnn.rcnn import Rcnn
from src.FasterRcnn.rpn import RPN
from src.FasterRcnn.roi_align import SingleRoIExtractor
from src.FasterRcnn.anchor_generator import AnchorGenerator
...
class Faster_Rcnn(nn.Cell):
    ...
    def __init__(self, config):
        ...
        # Backbone
        self.backbone = get_initialize_model(config, 80)

        # Fpn
        self.fpn_neck = HrnetFpn(config.fpn_in_channels, config.fpn_out_channels, config.fpn_num_outs)
    ...
    def construct(self, img_data, img_metas, gt_bboxes, gt_labels, gt_valids): # , img_metas, gt_bboxes, gt_labels, gt_valids
        """
