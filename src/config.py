...
config = ed({
    ...
    "mindrecord_dir": "/zzq_data/mycode/hrnetv2_mindspore/hrnetv2_mindspore/HRNetV2_det/hrnetv2p_fastercnn/cancel2/",         # fixme: "/disk2/lxq/mr/"
    "coco_root": "/zzq_data/mmdetection-master/data/coco/",  # fixme:  "./cocodataset/"
    ...
    "num_classes": 81,
    "neg_iou_thr_stage2_2": 0.6,
    "neg_iou_thr_stage2_3": 0.7,
