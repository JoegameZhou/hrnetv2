...
def parse_cli_to_yaml(parser, cfg, helper=None, choices=None, cfg_path="HrnetW48_fastercnn_config.yaml"):
    """
    ...
    """
    parser = argparse.ArgumentParser(description="[REPLACE THIS at config_henet.py]",
                                     parents=[parser])
...
# change config at here (line 123)
def get_config():
    """
    ...
    # current_dir = r'/zzq_data/mycode/hrnetv2_mindspore/hrnetv2_mindspore/HRNetV2_det/hrnetv2p_fastercnn/'
    parser.add_argument("--config_path", type=str, default=os.path.join(current_dir, "../../HrnetW48_fastercnn_config.yaml"),
