...
if [ $# -ge 1 ]; then
  if [ $2 == 'HrnetW32_fastercnn' ]; then
    CONFIG_FILE="${BASE_PATH}/../HrnetW32_fastercnn_config.yaml"
  elif [ $2 == 'HrnetW48_fastercnn' ]; then
    CONFIG_FILE="${BASE_PATH}/../HrnetW48_fastercnn_config.yaml"
  else
