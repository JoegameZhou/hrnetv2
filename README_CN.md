...
- 在 ModelArts 进行训练 (如果你想在modelarts上运行，可以参考以下文档 [modelarts](https://support.huaweicloud.com/modelarts/))
    ...
    # 在 ModelArts 上使用8卡训练
    # (1) 执行a或者b
    #       a. 在 HrnetW32_fastercnn_config.yaml 文件中设置 "enable_modelarts=True"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 "distribute=True"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 "data_path='/cache/data'"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 "epoch_size: 20"
    #          (可选)在 HrnetW32_fastercnn_config.yaml 文件中设置 "checkpoint_url='s3://dir_to_your_pretrained/'"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 其他参数
    ...
    # (1) 执行a或者b
    #       a. 在 HrnetW32_fastercnn_config.yaml 文件中设置 "enable_modelarts=True"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 "checkpoint_url='s3://dir_to_your_trained_model/'"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 "checkpoint='./faster_rcnn/faster_rcnn_trained.ckpt'"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 "data_path='/cache/data'"
    #          在 HrnetW32_fastercnn_config.yaml 文件中设置 其他参数
    #       b. 在网页上设置 "enable_modelarts=True"
...
└─faster_rcnn
  ...
  ├─src
    ...
    ├─util.py                        // 例行操作
    └─model_utils
      ├─config_henet.py                    // 获取.yaml配置参数
      ├─device_adapter.py            // 获取云上id
      ├─local_adapter.py             // 获取本地id
      └─moxing_adapter.py            // 云上数据准备
  ├─HrnetW32_fastercnn_config.yaml              // Resnet50相关配置
